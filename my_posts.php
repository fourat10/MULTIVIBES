...
<body>
    ...
    <div class="container">
        ...
        $query = "SELECT post.id, post.title, post.created_at, post.photo, post.category_id, category.category AS category, user.username 
          FROM post
        ...
        if (!$result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<a href="view.php?id=' . htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8') . '" class="btn btn-success btn-sm" style="margin-right: 20px;">View</a>';
